...
const setBackgroundImage = () => {
    ...
    document.body.style.backgroundImage = `url(https://raw.githubusercontent.com/tmiguel78/project-break-dashboard/refs/heads/main/assets/backgroundImages/${arrBackgroundImages[indiceImagen]})`;
